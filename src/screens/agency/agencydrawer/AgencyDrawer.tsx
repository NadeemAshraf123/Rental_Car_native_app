...
const AgencyDrawer: React.FC<AgencyDrawerProps> = ({ navigation }) => {
  ...
  const handleAccountSelection = (targetAccount: 'owner' | 'Agency') => {
    ...
    if (targetAccount === 'Agency') {
      navigation.replace('AgencyDrawer'); // Go to agency drawer
    } else {
      navigation.replace('HomeScreen'); // Go to user home
    }
  };
...
//         <Image source={require('../../../assets/agencyreistration/profile1.png')} style={dynamicStyles.profileImage} />
//         <TouchableOpacity style={dynamicStyles.cameraIcon}>
//           <Icon name="photo-camera" size={12} color="#fff" />
//         </TouchableOpacity>
//       </View>
...
//       <View style={dynamicStyles.card}>
//         <TouchableOpacity style={dynamicStyles.row} onPress={() => navigation.navigate('EditAgencyProfile')}>
//           <Icon name="edit" size={15} color={isDark ? '#fff' : '#000'} />
//           <Text style={dynamicStyles.rowText}>Edit profile information</Text>
//         </TouchableOpacity>

//         <TouchableOpacity style={dynamicStyles.row} onPress={() => navigation.navigate('AgencyNotificationScreen')}>
//           <Icon name="notifications" size={15} color={isDark ? '#fff' : '#000'} />
//           <Text style={dynamicStyles.rowText}>Notifications</Text>
//           <View style={dynamicStyles.toggleContainer}>
//             <Text style={{ color: notificationsEnabled ? '#F9864A' : '#ccc' }}>
