...
function App(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    const subscription = storage.addOnChangedListener((key) => {
      if (key === 'userRole') {
  ...
  const RoleBasedRootNavigator = () => {
    ...
    if (userRole === 'Agency') {
      return (
        <Stack.Navigator
          initialRouteName="AgencyDrawer" // Start with the Agency Drawer
          screenOptions={{
            headerShown: false,
          ...
          {/* Agency Screens added to the stack for navigation outside the drawer */}
          <Stack.Screen name="RegistrationScreen" component={ RegistrationScreen  } />
          <Stack.Screen name="AgencyProfileScreen" component={ AgencyProfileScreen  } />
          ...
          {/* All other Agency-specific screens */}
        </Stack.Navigator>
      );
    }
  }
  ...
  return (
        <Stack.Navigator
          ...
          <Stack.Screen name="Home" component={UserDrawerNavigator} /> {/* Your existing User Drawer */}
          {/* All other User-side/Auth Screens */}
